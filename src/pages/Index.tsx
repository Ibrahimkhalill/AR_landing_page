            ...
            <div className="mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mt-12">
              <div className="rounded-lg border bg-card shadow-sm overflow-hidden">
                <div className="relative aspect-square lg:aspect-video">
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-500/20 to-purple-500/20 flex items-center justify-center">
                    <div className="rounded-lg bg-black/50 text-center p-8">
                      <h3 className="text-xl font-semibold text-white mb-4">3D Food Model Demo</h3>
                      <Button variant="secondary">
                        Play Demo
                      </Button>
                    </div>
                        ...
                        <Card>
                          <CardContent className="flex aspect-video items-center justify-center p-6">
                            <div className="text-center space-y-4">
                              ...
                              <p className="text-muted-foreground">Interactive 3D menu experience</p>
                              <div className="rounded-lg border bg-card shadow-sm overflow-hidden aspect-video">
                                <div className="absolute inset-0 bg-gradient-to-br from-blue-500/20 to-purple-500/20 flex items-center justify-center">
                                  <div className="rounded-lg bg-black/50 text-center p-8">
                                    <h3 className="text-xl font-semibold text-white mb-4">Restaurant Example {index + 1}</h3>
                                    <Button variant="secondary">
                                      View Demo
                                    </Button>
                                  </div>
